        ...
        <div className='design-page'>
            <div className='design-page-img'>
                <div className='design-text'>
                    ...
                    <br/>
                    <h6>Hẹn gặp ngay đội ngũ chuyên nghiệp và giàu kinh nghiệm để được tư vấn những giải pháp hoàn thiện nội thất cho ngôi nhà của bạn.</h6>
                    <br/>
                    <h3>Liên hệ ngay : 0865762255</h3>
                </div>
            </div>
            <div className='row get-info-design'>
                    <div className='col-6 info-img'>
                    </div>
                    <div className='col-6'>
                    <h3>Đăng ký tư vấn tại nhà</h3>
                    <h6>Hẹn gặp ngay tư vấn thiết kế nội thất tại nhà bằng cách để lại thông tin tại form dưới đây</h6>
