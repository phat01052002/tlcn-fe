...
export default function ListCategoryByRoom({roomId}) {
    // get data room
    useEffect(()=>{
        axios.get(`/guest/room/categories/1`)
        .then(res=>room1=res.data)
        .catch(error=>console.log(error))
        axios.get(`/guest/room/categories/2`)
        .then(res=>room2=res.data)
        .catch(error=>console.log(error))
        axios.get(`/guest/room/categories/3`)
        .then(res=>room3=res.data)
        .catch(error=>console.log(error))
        axios.get(`/guest/room/categories/4`)
        .then(res=>room4=res.data)
        .catch(error=>console.log(error))
        axios.get(`/guest/room/categories/5`)
        .then(res=>room5=res.data)
        .catch(error=>console.log(error))
        axios.get(`/guest/room/categories/6`)
        .then(res=>room6=res.data)
        .catch(error=>console.log(error))
        axios.get(`/guest/room/categories/7`)
