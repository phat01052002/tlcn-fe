    ...
    <div className='page-login row'>
      ...
      <div className='col-4'>
        <div className='form-control form-login '>
            ...
            <br/>
              <button className='form-control btn btn-info btn-login'>Đăng Nhập</button>
            <br/>
            <br/>
            <div className=' row'>
              <div className='col-4'>
              <a className='forgot-password-link' href='/'>Quên mật khẩu</a>
              </div>
              <div className='col-5'></div>
              <div className='col-3'>
              <a className='register-link' href='/'>Đăng ký</a>
            </div>
            <br/>
            <br/>
            </div>
            <button className='form-control btn btn-danger btn-login'>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="14" fill="currentColor" class="bi bi-google" viewBox="0 0 16 16">
